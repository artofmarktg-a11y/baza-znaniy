...
export type RolePermissionOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"role" | "permission" | "allowed" | "updatedAt", ExtArgs["result"]["rolePermission"]>
...
export interface RolePermissionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const rolePermissionWithPermissionOnly = await prisma.rolePermission.findMany({ select: { permission: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many RolePermissions and only return the `permission`
   * const rolePermissionWithPermissionOnly = await prisma.rolePermission.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more RolePermissions and only return the `permission`
   * const rolePermissionWithPermissionOnly = await prisma.rolePermission.updateManyAndReturn({
   *   select: { permission: true },
   *   where: {
   *     // ... provide filter here
   *   },
